...
1. Continue the [Gate 2 Kickoff — Constraints and Research Packet](https://docs.google.com/document/d/1WxC3eztHIbslJbgwaxxmq-f2hefXhJtOdSLqM5IeiPo/edit), [incident-notification eligibility matrix](https://docs.google.com/spreadsheets/d/1YjSBUpjJr9_YEPLnWssiF8ZB7Qw6pOIyL8SWgCK-gcA/edit), and [Point-Only Fire Geography work session](https://docs.google.com/document/d/1nyuS8VzbiQOxBLchk5Faj2RsG8MIQnHkyeiGanAmTdI/edit). The point-only geography rule is approved; next design the bounded WFIGS live-latency sample and use WildWeb lifecycle evidence to set separate initial-notification and current-context freshness durations before approving any new-fire source. John sent the WildWeb/WildCAD-E permission inquiry at 8:50 a.m. MDT on 2026-08-18 with no bounce-back observed as of the status update; follow up on 2026-08-25 if no response.
...
5. Complete the `Legal Review Prep` Clerky inspection and focused Cara follow-up by the 2026-08-20 action checkpoint; retain 2026-08-21 as the overall task deadline.
