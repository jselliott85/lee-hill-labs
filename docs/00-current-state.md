...
2. Continue `Research External Warning Feed Feasibility` in the [Gate 2 Kickoff — Constraints and Research Packet](https://docs.google.com/document/d/1WxC3eztHIbslJbgwaxxmq-f2hefXhJtOdSLqM5IeiPo/edit), [incident-notification eligibility matrix](https://docs.google.com/spreadsheets/d/1YjSBUpjJr9_YEPLnWssiF8ZB7Qw6pOIyL8SWgCK-gcA/edit), and [Point-Only Fire Geography work session](https://docs.google.com/document/d/1nyuS8VzbiQOxBLchk5Faj2RsG8MIQnHkyeiGanAmTdI/edit). The point-only and saved-home rules are approved; next design the bounded WFIGS live-latency sample and use lifecycle evidence to propose separate initial-notification and current-context freshness durations.
