...
1. Continue the [Gate 2 Kickoff — Constraints and Research Packet](https://docs.google.com/document/d/1WxC3eztHIbslJbgwaxxmq-f2hefXhJtOdSLqM5IeiPo/edit) and [incident-notification eligibility matrix](https://docs.google.com/spreadsheets/d/1YjSBUpjJr9_YEPLnWssiF8ZB7Qw6pOIyL8SWgCK-gcA/edit). Review the nine source rows, resolve the point-fire geography rule, send the urgent WildWeb/WildCAD-E permission inquiry, and design a bounded WFIGS live-latency sample before any new-fire notification approval.
