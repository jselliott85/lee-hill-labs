...
| ECA Product Design | Consolidate Resilience Lifecycle FigJam comments | High | Review and resolve open comments on the approved lifecycle board; record resulting decisions in canonical repo documents | In Progress — 5 of 19 comments resolved (2 more ready for John to resolve in Figma) | 2026-08-06 |
