...
**Current checkpoint — A1 approved low-fidelity; A2 Round 2 ready for founder review, 2026-09-10:** Claude completed the independent A2 review, John resolved all findings, and Cody recorded the approved boundaries before constructing a separate ten-view correction across S07–S12. The correction adds invalid-code and denied-membership recovery; corrects administrator language, queue/detail data treatment and S11; and carries the approved S12 shell with a reserved relevance slot on every Event row. Original A2/comment history and the approved S12 exploration remain untouched. The full A2 batch remains unapproved. A1 final copy, detailed consequential states, Event match-basis/order/grouping work, the overall roadmap task and Gate 3 remain open. See the [Round 2 handback](gate-3-lowfi-a2-correction-r2-20260910.md).

Status: A1 low-fidelity is founder-approved; its 13 app viewports across five parent families, X01 email sample and OS boundary panel remain the approved structural baseline. A2 Round 2 has ten verified app views across six additional parent families; its separate S12 exploration remains the founder-approved structural baseline. Round 2 now awaits John's review, and the full A2 batch is not approved low-fidelity. Eleven of 29 app parent families and X01 now have drawings; correction variants do not add parent families. The other 18 parents and X02 remain pending. The OS panel is a boundary note, not a new parent. INV product coverage and IDs remain authoritative.
...
| S08b (S08) | Resident | Denied membership recovery | [86:8](https://www.figma.com/design/GzK3TcwA0mPzn90gG6fWGK?node-id=86-8) | INV S08; 2026-09-10 review disposition | Round 2/A2; resubmit-code and pre-addressed administrator-email routes; persisted and image checked |
...
| S12a (S12) | Resident | Saved Home with usable location | [87:8](https://www.figma.com/design/GzK3TcwA0mPzn90gG6fWGK?node-id=87-8) | INV S12; approved exploration; 2026-09-10 review disposition | Round 2/A2; three separate Event rows with reserved relevance slots; global footer begins; persisted and image checked |
| S12b (S12) | Resident | Saved Home, location needed | [87:64](https://www.figma.com/design/GzK3TcwA0mPzn90gG6fWGK?node-id=87-64) | INV S12; approved exploration; no-location decisions | Round 2/A2; both Event losses plus Edit address; retained community/status/footer; persisted and image checked |
...
| S08.02 | Approved; denied; retry/new code; revoked/suspended; offline last-known | Denied frame + named pending states | Normal shell remains gated until approval. Approval may notify and routes to S11/S12. S08b R2 names the community, routes to S07 for resubmission, and offers pre-addressed `Contact Community Administrator`; revoked/suspended/offline variants remain Pass 2/A. |
...
| S12.01 | Home with usable location | Frame based on approved exploration | S12a R2 at `87:8` carries the approved IA: LHL header and short address, three separate Event rows with `[RELEVANCE — TBD]`, Community Summary, inline timestamped Home/Away status, and the first fixed five-destination footer without a social feed. |
| S12.02 | Location needed | Frame based on approved exploration | S12b R2 at `87:64` replaces only the Event preview with both Event losses and Edit address; Community Summary, Home Status, short address, and fixed footer remain. |
...
The [Round 3 handback](gate-3-lowfi-a1-correction-r3-20260910.md) records the executed correction and verification; the [Round 2 handback](gate-3-lowfi-a1-correction-r2-20260909.md) retains the review provenance. Product decisions were canonical before redraw. Claude reported zero Tier 1 findings, and John subsequently approved A1 low-fidelity. The [A2 handback](gate-3-lowfi-a2-20260910.md) retains the first-review provenance; Claude's review and John's dispositions are incorporated in the separate [A2 Round 2 handback](gate-3-lowfi-a2-correction-r2-20260910.md). The [S12 Home-shell exploration](gate-3-lowfi-s12-home-shell-exploration-20260910.md) remains the founder-approved structural reference. Round 2 is verified and now awaits John's review. Final copy/layout, detailed consequential states, Event match-basis/order/grouping work, full A2 approval, the roadmap task and Gate 3 remain open. No task Complete, commit, push or production code.
