...
* **Powdered sugar:** ½ cup
* **Chocolate flakes/shavings:** 2 cups (to coat the cake)
* **Maraschino cherries:** 8 whole
* **White candle:** 1 single candle
* Fish-shaped crackers, candies, solid waste, and dirt.
* Rhubarb juice (crossed out).
* Dehydrated organic granulates.
* Ethylbenzene and volatile malt material.
* Fiberglass resin and toasted polyester fiberglass.
* Garry's mod missing texture error.
...
3. **Whisk** flour, sugar, cocoa, baking powder, baking soda, and salt in a large bowl.
...
### Step 2: Assemble and Frost
1. **Whip** the heavy cream and powdered sugar until stiff peaks form.
2. **Place** the first cake layer on a serving plate and spread a layer of whipped cream on top.
3. **Place** the second cake layer on top of the cream.
4. **Frost** the entire outside of the cake with the remaining whipped cream.
5. **Coat** the top and sides completely with chocolate flakes.

### Step 3: Final Touches
1. **Pipe** 8 small stars of whipped cream evenly around the top edge.
2. **Place** one maraschino cherry on top of each cream star.
3. **Position** a single white candle in the center.
